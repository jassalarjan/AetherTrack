...
const ChangeLog = () => {
  ...
  const getEventColor = (eventType) => {
    if (eventType.includes('login') || eventType.includes('logout')) return 'bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-blue-300';
    ...
    if (eventType.includes('report')) return 'bg-violet-100 text-violet-800 dark:bg-violet-900 dark:text-violet-300';
