...
export const sendEmail = async ({ to, subject, html, text }) => {
  try {
    ...
    // Use async sending for reminders
  ...
  <div class="email-wrapper">
    <div class="container">
      ...
      <div class="content">
        ...
        <p style="font-size: 16px; color: #4a5568;">Please review and update these tasks as soon as possible to keep your Tasks on track. 🎯</p>
